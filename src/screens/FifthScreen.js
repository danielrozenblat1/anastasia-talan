...
return <>
    ...
    <Box title="מקום לתיקונים ושינויים" description="ברגע שהאיפור כבר עלייך חשוב לי שתביני שיש לך את הsafe space לבוא אלי במידה ומשהו פחות נראה לך טוב כדי שנשנה ונתקן אותו!" icon={change}/>
    ...
    <NewBox title="פגישת ייעוץ" icon={meet} description="אנחנו נפגשות פנים מול פנים כחודש לפני החתונה כדי להבין איזה סוג איפור את רוצה וצריכה"/>
    ...
    <div className={styles.title}>טעימה לכלות שבחרו בי</div>
    <Recommends/>
